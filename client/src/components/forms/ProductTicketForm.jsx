...
/**
 * Shared ProductTicketForm component used for both creating and editing tickets
 * This ensures consistent UI and functionality across create and edit modes
 */
const ProductTicketForm = ({
  mode = 'create', // 'create' or 'edit'
  ticket = null, // For edit mode
  template = null,
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* MilliporeSigma Branding Header - Only show in create mode or when explicitly requested */}
      {showHeader && (
        <>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-white">
                  <h1 className="text-2xl font-bold">
                    {mode === 'edit' ? `Editing: ${ticket?.ticketNumber}` : 'Chemical Product Development'}
                  </h1>
                  <p className="text-blue-100">
                    {mode === 'edit'
                      ? `Make changes to your ${ticket?.status?.toLowerCase()} ticket below`
                      : 'New Product Development & Introduction (NPDI) System'
                    }
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900">
                  {mode === 'edit' ? 'Edit Product Ticket' : 'Create New Product Ticket'}
                </h2>
      ...
      {/* Import from SAP button - Always show at top of form even when header is hidden */}
      {!showHeader && (
        <div className="mb-6">
...
export default ProductTicketForm;
