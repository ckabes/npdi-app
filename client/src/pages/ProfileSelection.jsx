...
const ProfileSelection = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      {/* Logo and title in top right corner of screen */}
      <div className="fixed top-8 right-8 flex items-center space-x-3 bg-white/90 backdrop-blur-sm rounded-lg px-4 py-3 shadow-lg" style={{ zIndex: 10 }}>
